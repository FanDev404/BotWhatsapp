...
export default {
    ...
    callback: async ({ m, command, cmdSuccess, cmdFailed }) => {
        try {
            ...
            await m.reply(fs.readFileSync(data[basename(m.text)].temp), m.chat, db.settings.replyType, [], m.sender, { type: "document", mimetype: "application/bin", fileName: basename(m.text), quoted: m })
